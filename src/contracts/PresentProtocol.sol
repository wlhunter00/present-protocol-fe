    ...
    IPresentProtocol
{
    ...
    function wrap(
        ...
        if (
            ...
            ERC165Checker.supportsInterface(nftContract, _INTERFACE_ID_ERC1155)
        ) {
    ...
    function setFee(uint128 _fee) external payable onlyOwner {
        fee = _fee;
    }
